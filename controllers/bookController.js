...
//     if (timeDiff > 1) fine = Math.floor(timeDiff / 1) * 10; // Calculate fine if more than 2 minutes
...
exports.returnBook = async (req, res) => {
  ...
  try {
    ...
    if (timeDiff > 1) fine = Math.floor(timeDiff / 1) * 10; // Calculate fine if more than 1 minute
